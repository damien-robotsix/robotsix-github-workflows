...
pytest:  ## Run Python/pytest test suites
	...
	pytest tests/test-pin-bump.py tests/test-lint-sarif-permissions.py tests/test-check-local-action-refs.py tests/test-lint-trigger-coverage.py tests/test-config-ownership-check.py -v
